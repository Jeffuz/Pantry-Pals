    ...
    return (
        ...
        style={{ backgroundImage: `url(${backgroundImage})` }}>
            ...
            <div className="ml-10 absolute top-14">
                ...
                <Link to="/filter">
                    <button className="transition duration-200 delay-100 bg-gray-500 hover:bg-gray-300  hover:text-gray-800  text-gray-100 font-bold py-1.5 px-4 rounded inline-flex items-center">
